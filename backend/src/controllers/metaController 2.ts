...
export const getApiCatalog = (req: any, res: any) => {
  res.json({
    project: "Platemates",
    summary:
      "Available endpoints are production-ready for the MVP. Planned endpoints are reserved for proposal-aligned future features.",
    ...catalog,
  });
};
